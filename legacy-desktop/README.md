...
> 🗄️ **This is the archived Java desktop version of ScholarMatch.** The active project is now
> a Next.js web app living at the repo root — see the [top-level README](../README.md). This
> code is kept for reference/history and is no longer actively developed. This repo is a fork
> of the original CSC207 course project — full credit to the original team and repo:
> [Guancheng-Chen/ScholarMatch](https://github.com/Guancheng-Chen/ScholarMatch).
